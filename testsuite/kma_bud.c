...
void
get_buffer_from_large_buffer(void* pagePtr, kma_size_t reqBufSize, kma_size_t largeBufSize, kma_size_t largeBufStartAddr)
{
...
void
add_buffer_to_free_list(void* pagePtr, int bufClass, kma_size_t bufStartAddr, kma_size_t bufSize)
{
