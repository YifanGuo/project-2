...
#define FALSE 0
#define TRUE 1
#define MAXSPACE (PAGESIZE - sizeof(kma_page_t*) - sizeof(mck2Header_t))
...
kma_free(void* ptr, kma_size_t size)
{
	...
	mck2Header_t* tempMck2Ptr = (mck2Header_t*)(((unsigned long)ptr & MASKOFFSET) + sizeof(kma_page_t*));
	...
	else	// return the buffer to the buffer list
	{
		...
		if(tempMck2Ptr->used == 0)
		{
			...
			tempPagePtr = *((kma_page_t**)((void*)tempMck2Ptr - sizeof(kma_page_t*)));
...
int initMck2(kma_size_t size)
{
	...
	*((kma_page_t**)page->ptr) = page;
	...
	if((size + sizeof(kma_page_t*) + sizeof(mck2Header_t)) > page->size)
	{
		free_page(page);
		return -1;
	}

	mck2Header_t* curMck2Ptr = (mck2Header_t*)((void*)page->ptr + sizeof(kma_page_t*));
